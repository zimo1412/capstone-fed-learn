...
from covid_nets import SimpleCNN
# from utils.cifar10_data_splitter import CIFAR10_ROOT
from utils.covid_dataset import COVID_Dataset, COVID_ROOT
...
class COVIDLearner(Learner):  # also supports CIFAR10ScaffoldLearner
    def __init__(
        self,
    ...
    def _create_datasets(self, fl_ctx: FLContext):
        ...
        if self.train_dataset is None or self.train_loader is None:
            ...
            self.train_dataset = COVID_Dataset(
                root=COVID_ROOT,
                data_idx=site_idx,
    ...
    def train(self, shareable: Shareable, fl_ctx: FLContext, abort_signal: Signal) -> Shareable:
        ...
        # val_acc_graph.append(acc)
        print('====val_acc_graph:',val_acc_graph)
