...
from pt.networks.covid_nets import SimpleCNN
from pt.utils.covid_dataset import COVID_Dataset, COVID_ROOT
...
class COVIDLearner(Learner):
    def __init__(
        ...
        """Simple COVID Trainer.

        Args:
            train_idx_root: directory with site training indices for COVID data.
    ...
    def _create_datasets(self, fl_ctx: FLContext):
        """To be called only after COVIDDataSplitter downloaded the data and computed splits"""
