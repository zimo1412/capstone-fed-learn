...
def main():
    ...
    parser.add_argument("--job", type=str, default="covid_fedavg", help="Path to job config.")
    parser.add_argument("--poc", action="store_true", help="Whether admin uses POC mode.")
    parser.add_argument(
        "--train_split_root", type=str, default="/tmp/covid_splits", help="Location where to save data splits."
    )
    parser.add_argument(
        "--alpha",
        type=float,
